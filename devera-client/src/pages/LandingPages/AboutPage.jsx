...
import moaImg from '../../assets/img/moa.png';
import lipaImg from '../../assets/img/lipa.png';
import sportHoodie from '../../assets/img/sporthoodie.jpg';
          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <img
                src={moaImg}
                alt="MOA"
                className="aspect-square w-full rounded-[1.25rem] object-cover border-2 border-zinc-300 transition hover:scale-105 hover:shadow-lg"
              />
